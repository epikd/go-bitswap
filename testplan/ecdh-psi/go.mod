module github.com/ipfs/go-bitswap/testplan/ecdh-psi
...
require (
	...
	github.com/epikd/psiMagic v0.0.0-20220913070932-e1de31b52092 // indirect
...
replace github.com/ipfs/go-bitswap => github.com/epikd/go-bitswap v0.0.0-20220913092211-ee261310463a
